...
- [imcitius/tgsieve](https://github.com/imcitius/tgsieve) - Terragrunt plans without the wall of text: reads terragrunt&#39;s JSON plan output, hides declared noise, collapses repeats, shows only real changes (1 week ago)
